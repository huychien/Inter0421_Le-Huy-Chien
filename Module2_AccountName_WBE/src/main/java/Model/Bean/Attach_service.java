...
public class Attach_service {
    ...
    public Attach_service(int attach_service_id, String attach_service_name, int attach_service_unit, double attach_service_cost, String attach_service_status) {
